...
for entry in _raw_genesets:
    ...
    HEATMAP_GENESETS.append({
        ...
        "pdf_zscore_four_seasons": f"results/de/plots/heatmap_zscore_{HEATMAP_GENOME_NAME}_{slug}_four_seasons.pdf",
        ...
        "pdf_zscore_general": f"results/de/plots/heatmap_zscore_{HEATMAP_GENOME_NAME}_{slug}_general.pdf",
    })
...
HEATMAP_ZSCORE_PDF_FOUR_SEASONS_TARGETS = [HEATMAP_GENESET_MAP[name]["pdf_zscore_four_seasons"] for name in HEATMAP_GENESET_NAMES]
...
HEATMAP_ZSCORE_PDF_GENERAL_TARGETS = [HEATMAP_GENESET_MAP[name]["pdf_zscore_general"] for name in HEATMAP_GENESET_NAMES]
